...
<template>
 ...
 -->
       ...
       <div style="min-height: 716px;z-index:99;" class="w-64  absolute      shadow md:h-full flex-col justify-between text-gray-800     bg-gray-100 dark:bg-gray-800 dark:text-white   left-0 overflow-scroll   "
